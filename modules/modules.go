...
func GetModule(name string, options definitions.Options, process definitions.Process) Module {

	if name == "nmap" {
		return nmap.New(options, process)
	}

	return generic.New(options, process)
}
